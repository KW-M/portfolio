...
import blendGradient from "$lib/images/cloudAssets/blendGradient.png?url";
...
import tileXCloud from "$lib/images/cloudAssets/Raw Clouds/Artboard2.png?url";
export const tileXCloudTexture = Texture.from(tileXCloud);

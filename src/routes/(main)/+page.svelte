...
<h1 class="absolute top-[2000vh] w-full overflow-visible text-center h1 text-9xl !py-80 -z-10 cursor-pointer select-none" onpointerdown={() => (emojis = getEmojis())}>{emojis}</h1>
